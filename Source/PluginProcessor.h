...
/*
 ...
 2) createParameters to control where this split happens.
...
namespace params
{
    ...
    inline const std::map<Name, juce::String>& GetParams()
    {
        static std::map<Name, juce::String> params =
        {
